        ...
        do {
            ...
            switch (menu) {
                case 1:
                    ...
                    int harga = Integer.parseInt(infoPaket[1]);

                    if (jenisMotor == 1) {
                        System.out.print("Kapasitas Bagasi (Liter): ");
                        int bagasi = scan.nextInt();
                        scan.nextLine();
                        listData.add(new MotorMatic(merkBaru, infoPaket[0], harga, bagasi));
                    } else if (jenisMotor == 2) {
                        System.out.print("Kapasitas Mesin (CC): ");
                        int cc = scan.nextInt();
                        scan.nextLine();
                        listData.add(new MotorSport(merkBaru, infoPaket[0], harga, cc));
                    }
